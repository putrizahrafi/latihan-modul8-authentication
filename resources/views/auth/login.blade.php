...
<div class="container">
    <div class="row justify-content-center">
        <div style="margin-top:130px;" class="col-md-5">
            <div class="card">
                <i style="color:blue; margin-left:200px; font-size:50px;" class="bi-hexagon-fill me-6"></i>
                <center><h1 style="font-size: 30px;">Employee Data Master</h1></center>
                <div class="card-body">
